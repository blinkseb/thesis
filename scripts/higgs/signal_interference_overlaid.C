...
void signal_interference_overlaid()
{
  ...
  TF1* func = new TF1("Signal + Interferences",Signal,350,900,2);
  ...
  TF1* func2 = new TF1("Signal + Interferences",Interference,350,900,2);
  ...
  TF1* func3 = new TF1("Signal + Interferences",Somme,350,900,3);
  ...
  func->SetMinimum(func2->GetMinimum() * 1.2);
  ...
  c->SaveAs("pseudoscalar_sig_int.pdf");
}
