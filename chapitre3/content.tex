...
Afin de prendre en compte les différences de performances de l'algorithme d'étiquetage des jets de \Pbottom entre les données et la simulation, des facteurs de corrections sont appliqués à la simulation, qui dépendent de la valeur du jet étiqueté comme \Pbottom. Pour CSVM, ces facteurs de corrections varient entre \SI{5}{\percent} pour les jets correctement étiquetés et \SI{17}{\percent} pour les jets légers incorrectement étiquetés \Pbottom.
