...
Les particules colorées issues de la génération de l'événement dur radient des gluons ou des photons. Les gluons peuvent eux même radier des gluons, émettant ainsi des particules en cascade, jusqu'à atteindre une échelle d'énergie fixée par le générateur : c'est la gerbe partonique. Une fois cette échelle atteinte, les gluons restant sont forcés à se désintégrer.
...
La reconstruction des vertex d'interactions utilise les traces précédemment reconstruites. Deux étapes sont nécessaires :
\begin{itemize}
...
De façon similaire, un lien entre les deux calorimètres est créé lorsque la position de l'agrégat formé dans le calorimètre électromagnétique est contenue dans la zone limitée par l'agrégat formé dans le calorimètre hadronique. L'enveloppe des agrégats peut ici aussi être agrandie d'une unité de chaque côté. La distance du lien est donné par $\Delta R$. %dans le plan ($\eta$, $\phi$).
...
\begin{itemize}
  ...
  \item À cause de leur grand temps de vie, les hadrons \PB vont se déplacer avant de ce désintégrer, donnant lieu à un vertex secondaire qui n'est pas dans l'axe du faisceau. La présence d'un tel vertex est un fort indicateur de la présence d'un jet de \Pbottom.
