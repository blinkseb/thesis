...
Une des propriétés remarquables du tenseur $G_{\mu\nu}^a$ est que, contrairement à $F_{\mu\nu}$, il contient des termes d'auto-interaction ($\propto G_\mu^b G_\nu^c$). En effet, les gluons étant médiateurs de l'interaction force et portant eux même une charge de couleur, ils peuvent interagir entre eux, comme on peut le voir figure \ref{fig:gluon_self_interaction}.
...
\begin{enumerate}
  ...
  \item Les termes de masse des fermions ne sont pas invariants sous une transformation de jauge locale : ils doivent être enlevés du Lagrangien. On verra par la suite que le même mécanisme permet d'ajouter des termes de masse au Lagrangien invariant de jauge locale.
\end{enumerate}
...
\begin{figure}
  \subcaptionbox{\label{fig:higgs_mgg}}[.45\linewidth]{\includegraphics[width=0.45\textwidth]{higgs_mgg.pdf}}\hfill
  \subcaptionbox{\label{fig:higgs_pvalue}}[.45\linewidth]{\includegraphics[width=0.45\textwidth]{higgs_pvalue.pdf}}
