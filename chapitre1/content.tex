...
\begin{figure}[t] \centering
  ...
  \caption{L'évolution des constantes de couplages du Modèle Standard en fonction de l'énergie. On remarque qu'à une certaine énergie, les constantes de couplages semblent être identiques : un signe d'une possible unification des interactions ?}
