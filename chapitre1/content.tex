...
Le mécanisme de Higgs prévoit donc l'existence d'un nouveau champ scalaire, le champ de Higgs. Le boson associé à une masse $m_h = \sqrt{2v^2\lambda}$. Le 4 juillet 2012, le CERN a officiellement annoncée la découverte d'une nouvelle particule compatible avec le boson de Higgs \citep{higgs_cms,higgs_atlas}. Selon les derniers résultats, ce boson a une masse de $m_h = \SI{125.9 \pm 0.4}{\GeV}$ \citep{pdg}. C'est donc la confirmation expérimentale que le mécanisme de Higgs existe bel et bien, et qu'il est à l'origine de la masse des particules fondamentales.
